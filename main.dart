            ...
            child: Center(
              child: Column(
                children: <Widget>[
                  ...
                  text("Rike Dwi Wahyuni", 32),
                  const Padding(padding: EdgeInsets.only(bottom: 5)),
                  text("Rike.065119003@unpak.ac.id", 16),
                  const Padding(padding: EdgeInsets.only(bottom: 5)),
                  text("081511372081", 16),
                  ...
                  Container(
                    ...
                    child: Column(
                        ...
                        children: const <Widget>[
                          ...
                          Text("Jl. R. Khanafiah No. 52 RT01/15, Kel. Cimahpar",
                              style: TextStyle(
                                color: Colors.grey,
                                fontSize: 14,
                                fontWeight: FontWeight.bold,
                              )),
                          Text("Kec. Bogor Utara Kota Bogor, Jawa Barat",
                              style: TextStyle(
                                color: Colors.grey,
                                fontSize: 14,
                                fontWeight: FontWeight.bold,
